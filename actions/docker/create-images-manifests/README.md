...
| **`oci-registry-username`** | Username configuration used to log against OCI registries. See <https://github.com/docker/login-action#usage>.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | **true**     | `${{ github.repository_owner }}` |
